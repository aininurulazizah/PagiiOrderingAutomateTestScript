...
WebUI.setText(findTestObject('Page_Checkout/Informasi Alamat Fields/input_kode pos'), '40555')

WebUI.setText(findTestObject('Page_Checkout/Informasi Alamat Fields/textarea_alamat'), 'Jl. Baros Utama No. 00')

WebUI.scrollToElement(findTestObject('Page_Checkout/Informasi Alamat Fields/textarea_alamat'), 0)

WebUI.click(findTestObject('Page_Checkout/Informasi Alamat Fields/img_targeting titik koordinat'))

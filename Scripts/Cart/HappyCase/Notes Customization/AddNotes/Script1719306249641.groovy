...
WebUI.callTestCase(findTestCase('AddToCart/HappyCase/SC01_Add Product To Cart/AddProductToCartWithValidStocksWithoutNotes'), [:], FailureHandling.STOP_ON_FAILURE)
